 ...
 * @author 8556
 */
public class Credito extends Pessoa {
    ...
    public Credito(int numero_da_conta, int  senha, int saldo) {
    ...
    System.out.println("O seu nome é: "+getNome ());
        ...
        System.out.println("O seu saldo é : R$1000,00 "+getSaldo());
