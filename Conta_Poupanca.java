 ...
 * @author 8556
 */
public class Conta_Poupanca extends Pessoa {
    ...
    public Conta_Poupanca(int numero_da_conta, int senha, int saldo) {
...
System.out.println("O seu nome é: "+getNome ());
        ...
        System.out.println("O seu saldo é de : R$ 725.50 "+getSaldo());
}
