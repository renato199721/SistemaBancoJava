 ...
 * @author 8556
 */
public class Conta_Salario extends Pessoa {
    ...
    public Conta_Salario(int numero_da_conta, int senha, int saldo) {
    ...
    public void setSaldo(int saldo) {
     ...
     System.out.println("O seu nome é: "+getNome ());
        ...
        System.out.println("O seu numero de conta é: "+getNumero_da_conta());
         System.out.println("O seu saldo é: R$ 300.00 "+getSaldo());
     }
}
